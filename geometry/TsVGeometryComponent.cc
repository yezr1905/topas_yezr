...
TsVGeometryComponent::TsVGeometryComponent(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM,
										   TsVGeometryComponent* parentComponent, G4VPhysicalVolume* parentVolume, G4String& name)
:fPm(pM), fParentComponent(parentComponent), fParentVolume(parentVolume), fEnvelopePhys(0), fEnvelopeLog(0),
...
TsVGeometryComponent* TsVGeometryComponent::InstantiateChild(G4String childName) {
	...
	TsVGeometryComponent* child = fGm->GetGeometryHub()->InstantiateComponent(fPm, fMm, fGm, this, fEnvelopePhys, childCompType, childName);
