...
TsSphere::TsSphere(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM,
...
void TsSphere::ComputeDimensions(G4Sphere& sphere, const G4int copyNo, const G4VPhysicalVolume*) const
{
	...
	sphere.SetInnerRadius( G4double(fTotalRMin + iR * fFullWidths[0] / fDivisionCounts[0]) );
